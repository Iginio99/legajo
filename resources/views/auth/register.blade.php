<nav class="py-14 bg-peda border-b border-black-100">
    <div class="w-full ">
        <h1 class="font-extrabold text-center flex justify-center text-3xl text-black">
            ESCUELA DE EDUCACIÓN SUPERIOR PEDAGÓGICA PÚBLICA DE CHIMBOTE   
        </h1>  
    </div>
</nav>
<x-guest-layout>
...
<footer class="bg-peda flex p-10">
    <div class="w-1/2">
        ...
        <div>
                ...
                <span class="text-black font-bold">info@pedagogicochimbote.edu.pe</span>
                ...
                <span class="text-black font-bold">Metropolitano M-C Lt-1 Nuevo Chimbote</span>
