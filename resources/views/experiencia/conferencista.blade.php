<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">3.3 CONFERENCISTA O PONENTE: </h1>
<div class="py-4 px-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <tr class=" bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $conferencista->documento }}" target="_blank">
    ...
    <x-primary-button v-if=!estado_conferencista @click="addConferencistas" class="bg-sky-500/50">Nueva Conferencia</x-primary-button>
   
    <form action="{{ url('add-conferencista') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div v-if=estado_conferencista class="flex space-x-4 items-center mt-4">
    ...
    <x-primary-button v-if=estado_conferencista @click="removeConferencistas">Cancelar</x-primary-button>
