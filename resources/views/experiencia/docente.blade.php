<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">3.1 DOCENTE: </h1>
<div class="py-4 px-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $expDocente->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-expDocente/'.$expDocente->institucion.'/'.$expDocente->year) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <x-primary-button v-if=!estado_docente @click="addDocentes" class="bg-sky-500/50">Nueva Experiencia Docente</x-primary-button>
   
    <form action="{{ url('add-expDocente') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div v-if=estado_docente class="flex space-x-4 items-center mt-4">
    ...
    <x-primary-button v-if=estado_docente @click="removeDocentes">Cancelar</x-primary-button>
