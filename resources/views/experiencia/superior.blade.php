<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">3.2 DOCENTE DE EDUC.SUPERIOR: </h1>
<div class="py-4 px-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $superior->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-superior/'.$superior->institucion.'/'.$superior->year) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <x-primary-button v-if=!estado_superior @click="addSuperiores" class="bg-sky-500/50">Nueva Experiencia Superior</x-primary-button>
   
    <form action="{{ url('add-superior') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div v-if=estado_superior class="flex space-x-4 items-center mt-4">
    ...
    <x-primary-button v-if=estado_superior @click="removeSuperiores">Cancelar</x-primary-button>
