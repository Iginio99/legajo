<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">2.4 CAPACITACIONES:</h1>
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $capacitacion->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-capacitacion/'.$capacitacion->denominacion.'/'.$capacitacion->institucion.'/'.$capacitacion->year.'/'.$capacitacion->otro) }}" method="POST">
                            @csrf
                            @method('DELETE')
