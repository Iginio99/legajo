<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">2.3 DIPLOMADOS Y EXPOSICIONES:</h1>
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $diplomado->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-diplomado/'.$diplomado->denominacion.'/'.$diplomado->institucion.'/'.$diplomado->year) }}" method="POST">
                            @csrf
                            @method('DELETE')
