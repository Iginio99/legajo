<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">2.2 GRADOS:</h1>
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $grado->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-grado/'.$grado->denominacion.'/'.$grado->institucion.'/'.$grado->year.'/'.$grado->otro) }}" method="POST">
                            @csrf
                            @method('DELETE')
