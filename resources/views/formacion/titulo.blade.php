<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">2.1 TITULOS():</h1>
        ...
        <tbody class="bg-gray-100 border-b border-black">
            @forelse ($titulos as $titulo)
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-titulo/'.$titulo->denominacion.'/'.$titulo->institucion.'/'.$titulo->year) }}" method="POST">
                            @csrf
                            @method('DELETE')
