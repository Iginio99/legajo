<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">4.2 ESPOSICIONES ARTÍSTICAS:</h1>
<div class="py-4 px-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $exposicion->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-exposicion/'.$exposicion->institucion.'/'.$exposicion->year) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <x-primary-button v-if=!estado_exposicion @click="addExposiciones" class="bg-sky-500/50">Nueva Exposición Artística</x-primary-button>
   
    <form action="{{ url('add-exposicion') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div v-if=estado_exposicion class="flex space-x-4 items-center mt-4">
            <div>
                <x-input-label for="institucion" :value="__('Evento')" />
    ...
    <x-primary-button v-if=estado_exposicion @click="removeExposiciones">Cancelar</x-primary-button>
