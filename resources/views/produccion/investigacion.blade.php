<h1 class="font-extrabold text-center py-2 flex text-1xl text-black ">4.1 INVESTIGACIÓN:</h1>
<div class="py-4 px-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <tr class="bg-gray-100 border-b border-black">
                    ...
                    <td class="py-4 px-6">
                        <div class="grid grid-cols-2">
                            <div>
                                <a href="{{ $investigacion->documento }}" target="_blank">
                    ...
                    <td class="py-4 px-8">
                        <form action="{{ url('delete-investigacion/'.$investigacion->institucion.'/'.$investigacion->year) }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <x-primary-button v-if=!estado_investigacion @click="addInvestigaciones" class="bg-sky-500/50">Nueva Investigación</x-primary-button>
   
    <form action="{{ url('add-investigacion') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div v-if=estado_investigacion class="flex space-x-4 items-center mt-4">
            <div>
    ...
    <x-primary-button v-if=estado_investigacion @click="removeInvestigacioness">Cancelar</x-primary-button>
